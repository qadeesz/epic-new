...
import Best_sellers from "../SHOP FROM APPLIANCES/best_sellers";
  ...
  render() {
    ...
    return (
      <div>
        ...
        <span className="kitchen_heading">Shop for Electronics</span>
        ...
        <div className="computing_shop">
          <ComputingShop perc="upto70" products={products} />
          {/* <Electronics perc="upto70" products={products} /> */}
        </div>
        <div className="upto50">
          <Upto50 />
        </div>
        <div className="fashion">
          <ComputingShop perc="upto50" products={products} />
