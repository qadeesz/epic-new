...
class ProductDetail extends React.Component {
  ...
  updateProduct = () => {
    ...
    debugger;
    fetch(baseUrl+'products/updateproduct', {
      headers:{
  ...
  updateOffer = (evt)=>{
    ...
    this.state.item['offer'] = evt.target.value;
    this.setState(item);
          ...
          <div style={{ display: "flex" }}>
            ...
            <div style={{ marginLeft: "20px" }} className="card_div">
              ...
              <div>
                ...
                <select value={this.state.item.offer || "None"} onChange={this.updateOffer}>
                  <option value="upto70">Upto 70%</option>
